...
<head>
    ...
    <title>Payment Confirmation | Synthesis Cafe</title>
    <!-- MDB icon -->
                                                        ...
                                                        <h5>You are about to Purchase
                                                            <b>
                                                                ...
                                                                if ($quantity == "1") {
                                                                    ...
                                                                    echo $quantity . " pieces";
                                                                }
                                                                ?>
                                                            </b>
                                                            of <b><?php echo $neco_pin; ?></b> for <b>&#8358;<?php echo number_format($new_amount); ?>.</b> Please if that is Correct Click on Continue
                                                        </h5>
                                                    </center>
                                                </div>
                                                        ...
                                                        function payWithPaystack() {
                                                            var handler = PaystackPop.setup({
                                                                ...
                                                                callback: function(response) {
                                                                    ...
                                                                    window.location.href = 'activate2.php?succesfullypaid=' + referenced;
                                                                },
                                                                onClose: function() {
