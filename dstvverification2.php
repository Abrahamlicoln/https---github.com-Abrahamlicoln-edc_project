...
if ($response->status == "true") {
    $insert = "INSERT INTO dstvplan(customer_id,smart_card,subscriber_phone,subscription_type,amount,date_purchased) VALUES('$customer_id','$smart_card_number','$buyer_phone','$plan','$main_ammount',NOW())";
    $result = mysqli_query($connection, $insert);
    $_SESSION['dstvsuccess1'] = "Set";
    echo '<script>
    window.location.href = "dstv.php";
            </script>';
} else {
    $_SESSION['dstverror1'] = "Set";
    echo '<script>
    window.location.href = "dstv.php";
            </script>';
}
