...
if (!$_GET["succesfullypaid"]) {
    ...
    if ($response->success == "true") {
        $pin = $response->pin;
        $insert = "INSERT INTO purchase_id(customer_id,buyer_phone,card_type,serial_number,pin,payment_status,amount,transaction_id,date_purchase) VALUES('$customer_id','$buyer_phone','$neco_pin','$pin','$pin','Successful','$amount','$reference',NOW())";
        $result = mysqli_query($connection, $insert);
        $_SESSION['necosuccess'] = "Set";
        $message = "Dear" . $buyer_phone . " Your NECO RESULT TOKEN is " . $pin . ".";
        $main_response = array();
