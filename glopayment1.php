...
<head>
    ...
    <title>Purchase Glo Data Plan | Synthesis Cafe</title>
    <!-- MDB icon -->
                                    ...
                                    <div class="row" style="margin-top:-10px;">
                                        <div class="col-12">
                                            <div class=" mb-3" style="margin-top:-40px;">
                                                ...
                                                <form action="gloactivate1.php" method="post">
                                                    <div class="mt-2 mb-5">
                                                        <center>
                                                    ...
                                                    <div class="text-center">
                                                        <button type="submit" name="activateglo" class="btn btn-success"><i class="fas fa-credit-card"></i> Contine</button>
