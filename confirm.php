...
if (isset($_POST['proceed'])) {
    $amount = filter_var(mysqli_real_escape_string($connection, $_POST['amount_wallet']), FILTER_SANITIZE_NUMBER_INT);
    $main_amount = intval($amount);
    $_SESSION['amount_wallet'] = $main_amount;
}
$main_amount = $_SESSION['amount_wallet'];
$email_address = $data['email_address'];
$fullname = $data['fullname'];
$phone_number = $data['phone_number'];
$percentage = 2 * $main_amount / 100;
$percentage = $percentage * 100;
$main_amount = ($main_amount * 100) + $percentage;
...
<head>
    ...
    <title>Wallet Deposit Confirmation | Synthesis Cafe</title>
    <!-- MDB icon -->
                                    ...
                                    <div class="row" style="margin-top:-10px;">
                                        <div class="col-12">
                                            <div class=" mb-3" style="margin-top:-40px;">
                                                ...
                                                <div class="mt-2 mb-2">
                                                    <center>
                                                        <h5> Dear <b><?php echo $data['fullname']; ?></b> You are about to Deposit <?php echo "&#8358;" . number_format($amount); ?> to your Wallet Account. Please if that is Correct Click on Pay Now
                                                </div>
                                                        ...
                                                        function payWithPaystack() {
                                                            var handler = PaystackPop.setup({
                                                                ...
                                                                callback: function(response) {
                                                                    ...
                                                                    window.location.href = 'walletactivate.php?succesfullypaid=' + referenced;
                                                                },
                                                                onClose: function() {
