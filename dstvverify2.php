...
<head>
    ...
    <title>DSTV Verification Successful | Synthesis Cafe</title>
    <!-- MDB icon -->
                                    ...
                                    <div class="row" style="margin-top:-10px;">
                                        <div class="col-12">
                                            <div class=" mb-3" style="margin-top:-40px;">
                                                ...
                                                <div class="mt-2 mb-5">
                                                    <center>
                                                        <h5>You are about to do DSTV Subscription to <b><?php echo $customer_name; ?></b>. The Plan you Selected is
                                                            <b>
                                                                <?php
                                                                $select = "SELECT * FROM dstvplantobe WHERE plan_code = '$plan_selected'";
                                                            ...
                                                            for <b>&#8358;<?php echo number_format($main_ammount); ?> </b> . Please if that is Correct Click on Pay Now
                                                        </h5>
                                                    </center>
                                                </div>
                                                        ...
                                                        function payWithPaystack() {
                                                            var handler = PaystackPop.setup({
                                                                ...
                                                                callback: function(response) {
                                                                    ...
                                                                    window.location.href = 'dstvverification1.php?succesfullypaid=' + referenced;
                                                                },
                                                                onClose: function() {
