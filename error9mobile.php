...
<head>
    ...
    <title>Error for 9MOBILE Data Plan | Synthesis Cafe</title>
    <!-- MDB icon -->
                                        ...
                                        <div class="col-12">
                                            <div class=" mb-3" style="margin-top:-40px;">
                                                <center>
                                                    ...
                                                    <lottie-player src="https://assets2.lottiefiles.com/packages/lf20_qpwbiyxf.json" background="transparent" speed="0.2" style="width: 200px; height: 200px;" loop autoplay></lottie-player>
                                                </center>
                                                <div class="mt-2 mb-5">
                                                    <center>
                                                        <h5 class="text-danger">Sorry this Phone Number <b><?php echo $buyer_phone; ?></b> is not a 9mobile Number.<br>
                                                ...
                                                <div class="text-center">
                                                    <a class="btn btn-success" href="https://wa.me/+2348066178827">Click Here to Whatsapp Us</a>
                                                </div>
                                            </div>
