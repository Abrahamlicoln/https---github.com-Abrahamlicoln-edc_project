...
<head>
    ...
    <title>Wallet Deposit Successful | Synthesis Cafe</title>
    <!-- MDB icon -->
                                    ...
                                    <div class="row" style="margin-top:-10px;">
                                        <div class="col-12">
                                            <div class=" mb-3" style="margin-top:-40px;">
                                                ...
                                                <div class="mt-2 mb-2">
                                                    <center>
                                                        <h5> Dear <b><?php echo $data['fullname']; ?></b> You are have Successfully Deposited <?php echo "&#8358;" . number_format($amount); ?> to your Wallet Account. Click on Return to Home to View it.
                                                </div>

                                            </div>
                                            <div class="text-center mt-3">
                                                <a class="btn btn-success" href="dashboard.php">Return to Home</a>
