                                            ...
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select mb-3" name="" required="" readonly>
                                                        <option selected value="glo">DSTV Subscription</option>
                                                    </select>
                                                </div>
                                                <div class=" form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" required class="form-control mb-3" maxlength="11" inputmode="numeric" name="smart_card_number" placeholder="Please Enter the IUC number you want to validate">
                                                    </div>
                                                </div>
                                            </div>
                                    </div>
                                    <div class="text-center">
                                        <button type="submit" name="validate" class="btn btn-success"><i class="fa fa-user"></i> Validate User</button>
                                    </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12 mt-3">
                        ...
                        <div class="card shadow-2-strong">
                            <div class="card-body ">
                                <!--Header-->
                                <div class="shadow-2-strong rounded pt-4 pb-2" style="background-color:#1B5E20; margin-top:-50px;">
                                    <h4 class="h4-responsive px-4 text-white" style="margin-top:-10px;"> DSTV Subscription History</h4>
                                </div>
                                <div class="mt-3">
                                    <div class="table-responsive">
                                        <table id="example" class="display" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                $select = "SELECT * FROM dstvplan WHERE customer_id='" . $customer_id . "' ORDER BY date_purchased DESC";
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        $subscription_type = $row['plan_name'];
...
Toast.fire({
  icon: 'success',
  title: 'Dear <b>$fullname</b> You have successfully do a DSTV Subscription.'
})
</script>";
                unset($_SESSION['dstvsuccess']);
            } elseif (isset($_SESSION['dstvsuccess1'])) {
                echo "<script>
const Toast = Swal.mixin({
  toast: true,
  position: 'top-end',
...
Toast.fire({
  icon: 'success',
  title: 'Dear <b>$fullname</b> You have successfully do a DSTV Subscription from your Wallet.'
})
</script>";
                unset($_SESSION['dstvsuccess1']);
            } elseif (isset($_SESSION['dstverror1'])) {
                echo "<script>
const Toast = Swal.mixin({
  toast: true,
  position: 'top-end',
