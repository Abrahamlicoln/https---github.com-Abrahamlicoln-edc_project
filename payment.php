                                                ...
                                                <div class="mt-2 mb-5">
                                                    <center>
                                                        <h5>You are about to Purchase
                                                            ...
                                                            of <b><?php echo $waec_pin; ?></b> for <b>&#8358;<?php echo number_format($new_amount); ?>.</b> Please if that is Correct Click on Continue
                                                        </h5>
                                                    </center>
                                                </div>
                                                        ...
                                                        function payWithPaystack() {
                                                            var handler = PaystackPop.setup({
                                                                ...
                                                                callback: function(response) {
                                                                    ...
                                                                    window.location.href = 'activate.php?succesfullypaid=' + referenced;
                                                                },
                                                                onClose: function() {
