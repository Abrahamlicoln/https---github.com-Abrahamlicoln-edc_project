...
$main_ammount = number_unformat($amount_total);
                                    ...
                                    <div class="row" style="margin-top:-10px;">
                                        <div class="col-12">
                                            ...
                                            <div class=" mb-3" style="margin-top:-40px;">
                                                ...
                                                <div class="mt-2 mb-5">
                                                    <form action="startimeactivate2.php" method="post">
                                                        <center>
                                                            <h5>You are about to do Startimes Subscription for <?php echo "<b>" . strtoupper($customer_name) . "</b>"; ?>. The Plan you choose is
                                                                ...
                                                                <b>
                                                                    . This will cost you <?php echo "&#8358;" . number_format($main_ammount); ?>. Please if that is correct click on Proceed
                                                            </h5>
                                                ...
                                                <div class="text-center">
                                                    <button type="submit" name="pay_now" class="btn btn-success"></i> Proceed</button>
                                                </div>
                                            </div>
                                            </form>
