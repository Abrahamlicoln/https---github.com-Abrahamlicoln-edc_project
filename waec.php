...
if (isset($_POST['buynow'])) {
    $waec_pin = filter_var(mysqli_real_escape_string($connection, $_POST['waec-pin']), FILTER_SANITIZE_STRING);
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                if ($wallet_balance >= $amount_total) {
                    ...
                    echo '<script>
    window.location.href = "activatewallet1.php";
            </script>';
                } else {
...
<head>
    ...
    <title>Buy WAEC | Synthesis Cafe</title>
    <!-- MDB icon -->
                ...
                <div class="row mt-5 mb-5">
                    ...
                    <div class="col-md-5 mb-5 ">
                        ...
                        <div class="card shadow-2-strong">
                            <div class="card-body ">
                                <!--Header-->
                                <div class="shadow-2-strong rounded pt-4 pb-2" style="background-color:#1B5E20; margin-top:-50px;">
                                    <h4 class="h4-responsive text-center text-white" style="margin-top:-10px;"> Buy WAEC PIN <span style="font-size:16px;">(Scroll down to View your Purchased PIN)</span></h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">

                                        <form action="waec.php" method="post">
                                            <div class="form-body">
                                                <div class="form-group">
                                                    <label class="fw-bold text-warning">Card Type</label>
                                                    <select class="form-select mb-3" name="waec-pin" required="" readonly>
                                                        <option value="WAEC Result Checker">WAEC Result Checker</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control mb-3" name="amount" value="2700" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                    ...
                    <div class="col-md-4 ">
                        ...
                        <div class="card shadow-2-strong">
                            <div class="card-body ">
                                <!--Header-->
                                <div class="shadow-1 rounded pt-4 pb-2 shadow-2-strong" style="background-color:#1B5E20; margin-top:-50px;">
                                    <h4 class="h4-responsive text-center text-white" style="margin-top:-10px;"><i class="fas fa-info-circle"></i></i> Guide</h4>
                                </div>
                                <h5 class="fw-bold mt-2">How to Check Your WAEC Result:</h5>
                                <li>
                                    Login to WAEC Result Checker website via <b><a style="text-decoration:none; color:green;" href="https://waecdirect.org">https://waecdirect.org</a></b>
                                </li>
                                <li>
                                    Enter your Examination Number. <b>E.g 42*******</b>
                                </li>
                                <li>
                                    Select Examination Type <b>e.g “May/June</b>
                                </li>
                                <li>
                                    Select Exams Year <b>e.g 2022</b>
                                </li>
                                <li>
                    ...
                    <div class="col-md-12 mt-3">
                        ...
                        <div class="card shadow-2-strong">
                            <div class="card-body ">
                                <!--Header-->
                                <div class="shadow-2-strong rounded pt-4 pb-2" style="background-color:#1B5E20; margin-top:-50px;">
                                    <h4 class="h4-responsive px-4 text-white" style="margin-top:-10px;"> WAEC Card Purchase History</h4>
                                </div>
                                <div class="mt-3">
                                    <div class="table-responsive">
                                        <table id="example" class="display" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                $select = "SELECT * FROM purchase_id WHERE customer_id='" . $customer_id . "' and card_type='WAEC Result Checker' and payment_status='Successful' ORDER BY date_purchase DESC";
                                                $result = mysqli_query($connection, $select);
                                                if (mysqli_num_rows($result) > 0) {
                                                    $counter = 0;
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $pin; ?></td>
                                                            <td> <a class="btn btn-success" href="printout1.php?parametersvalue=<?php echo $hash; ?>">Print PIN</a></td>
                                                            <td><?php echo $date; ?></td>
...
Toast.fire({
  icon: 'success',
  title: 'You have Successfully Purchase WAEC Result Checker PIN Please Scroll Down to Print it.'
})
</script>";
                unset($_SESSION['succeed']);
            } elseif (isset($_SESSION['waecsuccess'])) {
                echo "<script>
const Toast = Swal.mixin({
  toast: true,
  position: 'top-end',
...
Toast.fire({
  icon: 'error',
  title: 'You have Insufficient Balance to Purchase WAEC Result Checker PIN.'
})
</script>";
