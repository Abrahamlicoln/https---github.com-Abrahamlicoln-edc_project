...
<head>
    ...
    <title>Purchase 9MOBILE Data Plan | Synthesis Cafe</title>
    <!-- MDB icon -->
                            ...
                            <div class="card-body ">
                                ...
                                <div class="card-body">
                                    <div class="row" style="margin-top:-10px;">
                                        <div class="col-12">
                                            <form action="9mobileactivate1.php" method="post">
                                                <div class=" mb-3" style="margin-top:-40px;">
                                                    ...
                                                    <div class="mt-2 mb-5">
                                                        <center>
                                                            <h5>You are about to Purchase
                                                                <b>
                                                                    <?php
                                                                    $select = "SELECT * FROM 9mobile WHERE plan_type = '$mobile'";
                                                                    $result = mysqli_query($connection, $select);
                                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                                        $plan = $row['plan'];
                                                    ...
                                                    <div class="text-center">
                                                        <button type="submit" name="9mobileactivate" class="btn btn-success"><i class="fas fa-credit-card"></i> Continue</button>
