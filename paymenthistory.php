...
<head>
    ...
    <title>Payment History | Synthesis Cafe</title>
    <!-- MDB icon -->
                    ...
                    <div class="col-md-9 mt-2 ">
                        ...
                        <div class="card shadow-2-strong">
                            <div class="card-body ">
                                <!--Header-->
                                <div class="shadow-2-strong rounded pt-4 pb-2" style="background-color:#1B5E20; margin-top:-50px;">
                                    <h4 class="h4-responsive px-4 text-white" style="margin-top:-10px;"> <i class="fas fa-redo-alt"></i>&nbsp;Payment History</h4>
                                </div>
                                <div class="mt-3">
                                        ...
                                        <table id="example" class="display" style="width:100%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    $select = "SELECT * FROM purchase_id WHERE customer_id='$customer' and payment_status='Successful' ORDER BY date_purchase DESC";
                                                    ...
                                                    if (mysqli_num_rows($result) > 0) {
                                                        ...
                                                        while ($row = mysqli_fetch_assoc($result)) {
                                                            ...
                                                            $date = date("j F, Y", strtotime($date_purchase));
                                                    ...
                                                    ?>
                                                            ...
                                                            <td><?php echo $date; ?></td>
                                                            <td><span class="bg-success rounded p-1 text-white mt-1">Successful</span></td>
                                                </tr>
                                        <?php
                                                        }
                                                    }
