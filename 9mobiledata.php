...
if (isset($_POST['buynow'])) {
    $mobile = filter_var(mysqli_real_escape_string($connection, $_POST['mobile']), FILTER_SANITIZE_STRING);
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                if ($wallet_balance >= $amount_total) {
                    ...
                    echo '<script>
    window.location.href = "9mobilepayment1.php";
            </script>';
                } else {
        ...
        echo '<script>
    window.location.href = "9mobilepayment.php";
            </script>';
    }
}
?>
...
<head>
    ...
    <title>Purchase 9mobile Data Bundle | Synthesis Cafe</title>
    <!-- MDB icon -->
...
<body style="background-color:#FBFBFB;">
    ...
    <div id="preview" class="preview">
        ...
        <div>
                    ...
                    <div class="col-md-5 mb-5 ">
                        ...
                        <div class="card shadow-2-strong">
                            <div class="card-body ">
                                <!--Header-->
                                <div class="shadow-2-strong rounded pt-4 pb-2" style="background-color:#1B5E20; margin-top:-50px;">
                                    <h4 class="h4-responsive text-center text-white" style="margin-top:-10px;"> Purchase 9mobile Data <span style="font-size:16px;">(Scroll down to View your Tranx)</span></h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form action="9mobiledata.php" method="post">
                                            <div class="form-body">
                                                <div class="form-group">
                                                    <label class="fw-bold text-warning mt-2">Network Type</label>
                                                    <select class="form-select mb-3" name="" required="" readonly>
                                                        <option selected value="glo">9mobile Data Plan</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label class="fw-bold text-warning mt-2">Select Data Plan</label>
                                                    <select class="form-select mb-3" onchange="GetDetail(this.value)" name="mobile" required="" readonly>
                                                        <option value="">-----Select Data Plan----</option>
                                                        <?php
                                                        $select = "SELECT * FROM 9mobile";
                                                        $result = mysqli_query($connection, $select);
                                                        while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <div class="table-responsive">
                                        <table id="example" class="display" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                $select = "SELECT * FROM 9mobiledata WHERE customer_id='" . $customer_id . "'";
                                                $result = mysqli_query($connection, $select);
                                                if (mysqli_num_rows($result) > 0) {
                                                    $counter = 0;
                                                    while ($row = mysqli_fetch_assoc($result)) {
            ...
            if (isset($_SESSION['insuffient'])) {
                ...
                Toast.fire({
                    icon: 'error',
                    title: 'You have Insufficient Balance to Purchase 9Mobile Data Plan.'
                })
            </script>";
    ...
    <script>
        function GetDetail(str) {
            ...
            xmlhttp.open("GET", "fetch4.php?search=" + str, true);
            xmlhttp.send();
        }
    </script>
