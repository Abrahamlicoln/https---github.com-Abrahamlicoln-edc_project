...
<head>
    ...
    <title>Upgrade to Reseller | Synthesis Cafe</title>
    <!-- MDB icon -->
                                    ...
                                    <div class="row" style="margin-top:-10px;">
                                        <div class="col-12">
                                            <div class=" mb-3" style="margin-top:-40px;">
                                                <h5 class="my-3 text-success fw-bolder">Reseller Price List</h5>
                                                <hr>
                                                <p class="my-4 text-danger fw-bolder">
                                                    Note that after upgrade, you will still see the old prices during purchase, but once you purchase a product you will only be charged at reseller rates (meaning the new reseller prices will only be deducted from your wallet). You can confirm this in your wallet.
                                                </p>
                                                    ...
                                                    <table class="table align-middle mb-0 bg-white">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    MTN SME DATA @₦218/GB, <br>
                                                                    MTN CG DATA @₦236/GB,<br>
                                                                    AIRTEL CG DATA @₦221/GB,<br>
                                                                    AIRTEL DIRECT GIFTING - 2GB @₦1071,<br>
                                                                    GLO 2.9GB @₦897,<br>
                                                                    9MOBILE 1.5GB @₦837.
                                                                </td>
                                                ...
                                                <p class="my-4 text-success fw-bolder">
                                                    Upgrade Now at NGN1,000 one time fee. Please if you are Ready Click on Pay Now
                                                </p>
                                                <center>
                                                    <button type="submit" onclick="payWithPaystack()" class="btn btn-success"><i class="fas fa-credit-card"></i> Pay Now</button>
                                                        ...
                                                        function payWithPaystack() {
                                                            var handler = PaystackPop.setup({
                                                                ...
                                                                callback: function(response) {
                                                                    ...
                                                                    window.location.href = 'reselleractivate.php?succesfullypaid=' + referenced;
                                                                },
                                                                onClose: function() {
