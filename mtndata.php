...
if (isset($_POST['buynow'])) {
    $mtn = filter_var(mysqli_real_escape_string($connection, $_POST['mtn']), FILTER_SANITIZE_STRING);
    ...
    if ($payment_method == "e-wallet") {
        $amount = filter_var(mysqli_real_escape_string($connection, $_POST['amount']), FILTER_SANITIZE_STRING);
        echo '<script>
    window.location.href = "mtnpayment1.php";
            </script>';
    } else {
        echo '<script>
    window.location.href = "mtnpayment.php";
            </script>';
    }
}
?>
...
<head>
    ...
    <title>Purchase MTN Data Bundle | Synthesis Cafe</title>
    <!-- MDB icon -->
...
<body style="background-color:#FBFBFB;">
    ...
    <div id="preview" class="preview">
        ...
        <div>
                    ...
                    <div class="col-md-5 mb-5 ">
                        ...
                        <div class="card shadow-2-strong">
                            <div class="card-body ">
                                <!--Header-->
                                <div class="shadow-2-strong rounded pt-4 pb-2" style="background-color:#1B5E20; margin-top:-50px;">
                                    <h4 class="h4-responsive text-center text-white" style="margin-top:-10px;"> Purchase MTN Data <span style="font-size:16px;">(Scroll down to View your Tranx)</span></h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form action="mtndata.php" method="post">
                                            <div class="form-body">
                                                <div class="form-group">
                                                    <label class="fw-bold text-warning mt-2">Network Type</label>
                                                    <select class="form-select mb-3" name="" required="" readonly>
                                                        <option selected value="glo">MTN Data Plan</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label class="fw-bold text-warning mt-2">Select Data Plan</label>
                                                    <select class="form-select mb-3" onchange="GetDetail(this.value)" id="dataplan" name="mtn" required="" readonly>
                                                        <option value="">-----Select a Data Plan----</option>
                                                        <?php
                                                        $select = "SELECT * FROM mtn";
                    ...
                    <div class="col-md-12 mt-3">
                        ...
                        <div class="card shadow-2-strong">
                            <div class="card-body ">
                                <!--Header-->
                                <div class="shadow-2-strong rounded pt-4 pb-2" style="background-color:#1B5E20; margin-top:-50px;">
                                    <h4 class="h4-responsive px-4 text-white" style="margin-top:-10px;"> MTN Data Plan Purchase History</h4>
                                </div>
                                <div class="mt-3">
                                    <div class="table-responsive">
                                        <table id="example" class="display" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                $select = "SELECT * FROM mtndata WHERE customer_id='" . $customer_id . "'";
                                                $result = mysqli_query($connection, $select);
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        $date = date("l, F j, Y | <b>H:i:sA</b>", strtotime($date));
                                                ?>
                                                        <tr>
            ...
            if (isset($_SESSION['insuffient'])) {
                ...
                Toast.fire({
                    icon: 'error',
                    title: 'You have Insufficient Balance to Purchase MTN Data Plan.'
                })
            </script>";
    ...
    <script>
        function GetDetail(str) {
            ...
            xmlhttp.open("GET", "fetch3.php?search=" + str, true);
            xmlhttp.send();
        }
    </script>
