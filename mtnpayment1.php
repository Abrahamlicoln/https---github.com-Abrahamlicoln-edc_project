...
<head>
    ...
    <title>Purchase MTN Data Plan | Synthesis Cafe</title>
    <!-- MDB icon -->
...
<body style="background-color:#FBFBFB;">
    ...
    <style>
        #loader {
            ...
            width: 100%;
            height: 100vh;
            background: #F1F2F3 url('../img/prealoder.gif') no-repeat center;
            z-index: 999;
            display: none;
        }
    </style>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class=" mb-3" style="margin-top:-40px;">
                                                ...
                                                <div class="mt-2 mb-5">
                                                    <center>
                                                        <h5>You are about to Purchase
                                                            <b>
                                                                <?php
                                                                $select = "SELECT * FROM mtn WHERE plan_type = '$mtn'";
                                                                $result = mysqli_query($connection, $select);
                                                                while ($row = mysqli_fetch_assoc($result)) {
                                                                    $plan = $row['plan'];
                                                ...
                                                <div class="text-center">
                                                    <button type="submit" name="" id="mtnactivate1" class="btn btn-success"><i class="fas fa-credit-card"></i> Contine</button>
    ...
    <script>
        $(document).ready(function() {
            $("#mtnactivate1").on("click", function() {
                $.ajax({
                    type: "POST",
                    url: "mtnactivate1.php",
                    beforeSend: function() {
                        $("#loader").show();
                    },
                    complete: function() {
